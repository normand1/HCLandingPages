...
const BentoCard = ({
  ...
  >
    ...
    <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10">
      ...
      <h3 className={`text-xl font-semibold ${lightText ? "text-white" : "text-neutral-700"}`}>
        {name}
      </h3>
      <p className={`max-w-lg ${lightText ? "text-gray-200" : "text-neutral-400"}`}>
        {description}
      </p>
    </div>
